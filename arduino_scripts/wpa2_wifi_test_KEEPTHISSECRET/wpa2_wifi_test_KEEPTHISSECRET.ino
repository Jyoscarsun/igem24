...
char ssid[] = "UofT";  // your WPA2 enterprise network SSID (name)
char user[] = "YOUR_UTOR_HERE";  // your WPA2 enterprise username
char pass[] = "YOUR_PSWD_HERE";  // your WPA2 enterprise password
